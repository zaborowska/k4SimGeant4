#ifndef SIMG4COMPONENTS_G4FASTGDMLDETECTOR_H
#define SIMG4COMPONENTS_G4FASTGDMLDETECTOR_H
...
/** @class SimG4FastGdmlDetector SimG4Components/src/SimG4FastGdmlDetector.h SimG4FastGdmlDetector.h
 *
...
class SimG4FastGdmlDetector : public AlgTool, virtual public ISimG4DetectorConstruction {
public:
  explicit SimG4FastGdmlDetector(const std::string& aType, const std::string& aName, const IInterface* aParent);
  virtual ~SimG4FastGdmlDetector();
  /**  Initialize.
   *   @return status code
   */
