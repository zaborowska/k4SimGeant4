#ifndef MESHEVENTINFORMATION_H
#define MESHEVENTINFORMATION_H
 ...
 * Can be used for single particle events.
 *
 */
namespace sim {
  class MeshEventInformation : public G4VUserEventInformation
  {
    public:
    MeshEventInformation();
    virtual ~MeshEventInformation();
