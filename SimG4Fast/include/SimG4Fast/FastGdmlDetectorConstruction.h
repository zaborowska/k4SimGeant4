#ifndef SIMG4FAST_FASTGDMLDETECTORCONSTRUCTION_H
#define SIMG4FAST_FASTGDMLDETECTORCONSTRUCTION_H
...
/** @class FastGdmlDetectorConstruction SimG4Common/SimG4Common/FastGdmlDetectorConstruction.h FastGdmlDetectorConstruction.h
 *
...
namespace sim {
class FastGdmlDetectorConstruction : public G4VUserDetectorConstruction {
public:
  /**  Constructor.
   *   @param[in] aFileName Name of the GDML file with the detector description.
   */
  explicit FastGdmlDetectorConstruction(const std::string& aFileName, bool validate=false);
  virtual ~FastGdmlDetectorConstruction();
...
#endif /* SIMG4FAST_GFAstDMLDETECTORCONSTRUCTION_H */
